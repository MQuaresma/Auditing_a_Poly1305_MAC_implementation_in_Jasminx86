...
To perform this multiplciation, $r$ and $h$ are divided in five 4 byte(32 bit) blocks, called limbs \label{def_limb}, and multiplied with eachother as follows:
\begin{footnotesize}
...
\begin{verbatim}
poly1305_ref3(reg u64 out, reg u64 in, 
                reg u64 inlen, reg u64 k)
\end{verbatim}
